...
> Built with **Claude Opus 4.7** (Claude Code) using a plan-first, file-by-file
> review workflow. See [`plan.md`](plan.md), [`prompts.md`](prompts.md),
> [`DECISIONS.md`](DECISIONS.md), and [`Instructions.md`](Instructions.md).
